...
//        String[] hotelNames = getResources().getStringArray(R.array.hotelNames);
//        String[] roomTypes = getResources().getStringArray(R.array.hotelRoomTypes);
//        String[] location = getResources().getStringArray(R.array.location);
//        String[] price = getResources().getStringArray(R.array.price);
//
//        for (int i = 0; i < hotelNames.length; i++) {
//            Hotel currentHotel = new Hotel(hotelNames[i],roomTypes[i],location[i],Double.parseDouble(price[i]),
//                    img[i]);
